...
<head>
    ...
    <link href="{{URL::asset('/css/card.css') }}" rel="stylesheet" type="text/css">
    <link href="{{URL::asset('/css/categories.css') }}" rel="stylesheet" type="text/css">
    ...
    <link href="{{URL::asset('/css/applicant.css') }}" rel="stylesheet" type="text/css">
    <link href="{{URL::asset('/css/admin.css') }}" rel="stylesheet" type="text/css">
    <link href="{{URL::asset('/css/addApplicant.css') }}" rel="stylesheet" type="text/css">
